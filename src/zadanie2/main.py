...
def zad2(input_data):
    ...
    helper.create_small_plot_3(get_list_from_list_of_tuples(insert_list, 0),
                               ...
                               pic_name='small_data_comparisons.png',
    ...
    helper.create_small_plot_3(get_list_from_list_of_tuples(insert_list, 0),
                               ...
                               get_list_from_list_of_tuples(quick_list, 2),
                               get_list_from_list_of_tuples(merge_list, 2),
                               pic_name='small_data_moves.png',
                               y1_label='Insert Sort',
                               y2_label='Quick Sort',
                               y3_label='Merge Sort',
                               title='Number of elements copies while sorting')

    helper.create_small_plot_2(get_list_from_list_of_tuples(quick_list, 0),
                               get_list_from_list_of_tuples(quick_list, 1),
                               get_list_from_list_of_tuples(merge_list, 1),
                               pic_name='big_data_comparisons.png',
                               y1_label='Quick Sort',
                               y2_label='Merge Sort',
                               title='Number of elements comparisons while sorting')
